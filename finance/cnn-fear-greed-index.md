...
Cloudflare Worker가 뭔지 모르겠다면 먼저 [[cloudflare/cloudflare-worker-proxy|Cloudflare Worker로 간단한 proxy 만들기]]를 읽고, Worker URL을 만든 뒤 이 글로 돌아온다.
...
- [[cloudflare/cloudflare-worker-proxy|Cloudflare Worker로 간단한 proxy 만들기]]
